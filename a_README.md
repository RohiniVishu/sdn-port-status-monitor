...
## **References**  
1. Mininet documentation – [http://mininet.org/](http://mininet.org/ "http://mininet.org/")  
2. OSKen SDN Framework – [https://docs.openstack.org/os-ken/latest/](https://docs.openstack.org/os-ken/latest/ "https://docs.openstack.org/os-ken/latest/")  
3. Ryu – [https://ryu.readthedocs.io/](https://ryu.readthedocs.io/ "https://ryu.readthedocs.io/")  
4. OpenFlow 1.3 Specification – [https://opennetworking.org/wp-content/uploads/2014/10/openflow-spec-v1.3.0.pdf](https://opennetworking.org/wp-content/uploads/2014/10/openflow-spec-v1.3.0.pdf "https://opennetworking.org/wp-content/uploads/2014/10/openflow-spec-v1.3.0.pdf")  
5. Open vSwitch – [https://www.openvswitch.org/](https://www.openvswitch.org/ "https://www.openvswitch.org/")  
6. McKeown et al., "OpenFlow: Enabling Innovation in Campus Networks," ACM SIGCOMM CCR, 2008.  
   
##My Outputs:  
   
##Issues I faced (for documentational purposes):  
